...
export const Rate: FC<rateProps> = ({ rate }) => {
    ...
    useEffect(() => { setRateData(rate) }, [rate])
    useEffect(() => {
        let amount = 0
                                ...
                                <div className="w-full h-12 mb-4 flex outline outline-purple-400 rounded-sm md:w-5/12 md:mr-5">
                                    ...
                                    <div className="w-2/12 border-l-2 border-purple-700 testSelect hover:cursor-pointer">
                                        ...
                                        <div className="testOption h-32 w-14 border border-purple-700 rounded-sm  overflow-hidden overflow-y-auto absolute hidden bg-white">
                                            ...
                                            <div className="text-center py-2 border-b-2 border-slate-300 hover:bg-slate-200" onClick={() => changeRate(keyName, 4)}>4</div>
                                            <div className="text-center py-2 border-b-2 border-slate-300 hover:bg-slate-200" onClick={() => changeRate(keyName, 5)}>5</div>
                                            <div className="text-center py-2 border-b-2 border-slate-300 hover:bg-slate-200" onClick={() => changeRate(keyName, 6)}>6</div>
                                            <div className="text-center py-2 border-b-2 border-slate-300 hover:bg-slate-200" onClick={() => changeRate(keyName, 7)}>7</div>
                                            <div className="text-center py-2 border-b-2 border-slate-300 hover:bg-slate-200" onClick={() => changeRate(keyName, 8)}>8</div>
                                            <div className="text-center py-2 border-b-2 border-slate-300 hover:bg-slate-200" onClick={() => changeRate(keyName, 9)}>9</div>
                                            <div className="text-center py-2 border-b-2 border-slate-300 hover:bg-slate-200" onClick={() => changeRate(keyName, 10)}>10</div>
                                        </div>
